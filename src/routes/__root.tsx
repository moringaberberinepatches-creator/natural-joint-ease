...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Purisaki Berberine Patch reviews: how the transdermal berberine weight-loss patch works, real before/after results and 30-day money-back guarantee." },
      { property: "og:title", content: "Purisaki Berberine Patch — Real Reviews, Real Results, 30-Day Guarantee" },
      { property: "og:description", content: "Does the Purisaki Berberine Patch really work? Burn stubborn belly fat, balance blood sugar and reclaim your confidence — risk-free for 30 days." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Purisaki Berberine Patch — Real Reviews & Results" },
      { name: "twitter:description", content: "The transdermal berberine patch for weight management. 30-day money-back guarantee on the official site." },
